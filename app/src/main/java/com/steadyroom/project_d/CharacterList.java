...
public class CharacterList {
    ...
    static {
        BASE_POOL.add(new CharacterTemplate("단데기", 10, 16, 28, 38, 0, 2, R.drawable.ch1, 0.20));
        ...
        BASE_POOL.add(new CharacterTemplate("리자드", 14, 26, 35, 60, 1, 4, R.drawable.ch5, 0.25));
